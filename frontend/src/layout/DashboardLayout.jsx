                ...
                <header className={`sticky top-0 z-30 transition-all duration-300 ${
                    ...
                    <div className="flex items-center justify-between px-4 md:px-6 h-16">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {/* Create button */}
                            <button className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-600 text-white text-sm font-medium hover:shadow-lg hover:shadow-indigo-500/25 transition-all">
                                ...
                                {isProfileOpen && (
                                    <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-slate-900 rounded-xl shadow-xl border border-slate-200/80 dark:border-slate-700/80 overflow-hidden">
                                        <div className="px-4 py-3 border-b border-slate-200/80 dark:border-slate-700/80">
                                            ...
                                            <p className="text-xs text-slate-500 dark:text-slate-400">john@collabnest.com</p>
                                        </div>
                                        <div className="py-1">
